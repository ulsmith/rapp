describe("APP Component - app/two.component.html", function() {
	...
	beforeAll(function(done){
		...
		// load deps
		testFixture.innerHTML = '<link rel="import" href="base/src/app/two.component.html" />';
	...
	beforeEach(function(){
		...
		testBed.innerHTML = '<app-two></app-two>';
	});

    it('Creates a custom razilo component and binds to razilobind', function(){
		var component = testBed.querySelector('app-two');
